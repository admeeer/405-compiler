...
static const char *const yytname[] =
{
  ...
  "WRITE", "SEMICOLON", "EQ", "$accept", "program", "declarations",
...
#line 42 "parser.y"
           {
               ...
               new_node->declaration.type = (yyvsp[-2].string);
               new_node->declaration.identifier = (yyvsp[-1].string);
...
#line 1086 "parser.tab.c"
  ...
  case 8: /* statement: ID EQ expression SEMICOLON  */
#line 58 "parser.y"
          {
              if (!lookup_symbol((yyvsp[-3].string))) {
                  fprintf(stderr, "Error: Variable %s not declared.\n", (yyvsp[-3].string));
                  exit(1);
              }
              ASTNode* new_node = malloc(sizeof(ASTNode));
              new_node->type = NODE_TYPE_ASSIGNMENT;
              new_node->assignment.identifier = (yyvsp[-3].string);
              new_node->assignment.expression = (yyvsp[-1].node);
              (yyval.node) = new_node;
          }
...
#line 72 "parser.y"
           {
               ...
               new_node->number = (yyvsp[0].number);
               (yyval.node) = new_node;
           }
...
#line 79 "parser.y"
           {
               ...
               new_node->identifier = (yyvsp[0].string);
               (yyval.node) = new_node;
           }
